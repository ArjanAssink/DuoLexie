...
- [ ] **Hardop lezen rework** (plan: [docs/hardop-lezen-rework.md](docs/hardop-lezen-rework.md)): 10 kaarten per ronde, lont van 10s die korter wordt per Leitner-box, altijd eerst horen en dan pas sorteren, zichtbare stapels Goed!/Nog even met vlieg-animatie en ding, edelstenen 5 + 1 per goed woord + 3 perfect, opnamestudio-woordmodus voor 20 startwoorden. Nog te besluiten door Arjan: §9 van het plan.
