...
- [ ] **Hardop lezen rework** (plan: [docs/hardop-lezen-rework.md](docs/hardop-lezen-rework.md)): 10 verschillende kaarten per ronde (woordpool verbreed met vooruitkijken op het pad, geen herhalingen), lont van 10s die korter wordt per Leitner-box, Laat-horen-knop onthult het woord eerder, altijd eerst horen en dan pas sorteren, Proefronde op /proberen om het meteen met haar te testen, zichtbare stapels Goed!/Nog even met vlieg-animatie en ding, edelstenen 5 + 1 per goed woord + 3 perfect, opnamestudio-woordmodus voor 20 startwoorden. Nog te besluiten door Arjan: §9 van het plan.
